import { i as placements, r as isValidPlacement, t as settings } from "./astro_runtime_client_dev-toolbar_entrypoint__js.js";
import { n as createWindowElement, r as synchronizePlacementOnUpdate, t as closeOnOutsideClick } from "./window-DZGuhDk0.js";
//#region node_modules/blume/node_modules/astro/dist/runtime/client/dev-toolbar/apps/settings.js
var settingsRows = [
	{
		...
		changeEvent: (evt) => {
			if (evt.currentTarget instanceof HTMLInputElement) {
				...
				if (devToolbar) devToolbar.setNotificationVisible(!evt.currentTarget.checked);
...
var settings_default = {
	...
	init(canvas, eventTarget) {
		...
		function createSettingsWindow() {
			const windowElement = createWindowElement(`<style>
				...
				switch (setting.input) {
					...
					case "select": {
						...
						placements.forEach((placement) => {
							...
							if (placement === settings.config[setting.settingKey]) option.selected = true;
